...
<body class="<?php echo $this->params['controller'].'_'.$this->params['action'];?>">
	<?php
	if (APP_DEBUGMODE) {
...
(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/es_LA/all.js#xfbml=1&cookie=1&status=1&appId=211645485590601";
